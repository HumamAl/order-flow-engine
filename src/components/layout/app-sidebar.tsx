...
const navItems = [
  ...
  { href: "/order-pipeline", label: "Order Pipeline", icon: GitBranch },
  { href: "/api-monitor", label: "API Monitor", icon: Activity },
  { href: "/query-inspector", label: "Query Inspector", icon: Database },
